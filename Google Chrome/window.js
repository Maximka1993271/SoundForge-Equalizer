...
// ============================================
//  WINDOW.JS - SoundForge v3.22.8 Chrome 152
...
//  CHROME 152 OPTIMIZED: безопасная отправка сообщений
//  CHROME 152 OPTIMIZED: подключение к аудио (доверяем background)
//  CHROME 152 OPTIMIZED: кнопка эффектов
...
(function() {
  ...
  console.log('🪟 SoundForge Window v3.22.8 Chrome 152');
  ...
  // ============================================
  //  API DETECTION (CHROME 152 OPTIMIZED)
  // ============================================

  var api = (typeof chrome !== 'undefined' && chrome.runtime) ? chrome : null;
  ...
  // ============================================
  //  CONNECT/DISCONNECT (CHROME 152 OPTIMIZED)
  // ============================================
  ...
  // ============================================
  //  MESSAGE HANDLER (CHROME 152 OPTIMIZED)
  // ============================================
  ...
  function init() {
    ...
    console.log('✅ SoundForge Window Chrome 152 ready');
