// ============================================
//  LOGGER.JS - SoundForge v3.22.8 Chrome 152
...
//  Версия: 1.0.0
//  CHROME 152 OPTIMIZED: обработка ошибок localStorage
// ============================================
...
/**
 * Цвета для консоли (Chrome/Chromium совместимые)
 */
const COLORS = {
  ERROR: '#ff6b6b',
  WARN: '#ffd93d',
...
class Logger {
  ...
  /**
   * Вывод в консоль с форматированием (Chrome/Chromium совместимый)
   */
