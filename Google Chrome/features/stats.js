//  STATS.JS - SoundForge v3.22.8 Chrome 152
//  Google Chrome 152.0.7977.65 | Windows 11 25H2
//  Статистика использования
//  Энергосбережение: снижение частоты обновлений
//  CHROME 152 OPTIMIZED: очистка интервалов и обработка ошибок
// ============================================
...
function loadStats() {
  return new Promise(function(resolve) {
    ...
    if (chromeAPI.runtime.lastError) {
      console.warn('⚠️ Ошибка загрузки статистики:', chromeAPI.runtime.lastError);
...
function saveStats() {
  ...
  chromeAPI.storage.local.set({ [CONFIG.storageKey]: _stats }, function() {
    if (chromeAPI.runtime.lastError) {
      console.warn('⚠️ Ошибка сохранения статистики:', chromeAPI.runtime.lastError);
    }
  });
}
...
export function setPowerSaveMode(enabled) {
  ...
  chromeAPI.storage.local.set({ powerSaveMode: enabled }, function() {
    if (chromeAPI.runtime.lastError) {
      console.warn('⚠️ Ошибка сохранения powerSaveMode:', chromeAPI.runtime.lastError);
    }
  });
